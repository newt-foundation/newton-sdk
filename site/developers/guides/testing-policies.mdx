...
`opa test` is for **local unit tests only**. Production operators and Gateway simulation evaluate Rego with **Regorus** — see the [Newton Mental Model](/developers/overview/mental-model).
