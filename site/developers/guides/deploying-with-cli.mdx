...
description: "Deploy Newton Protocol policies and WASM data oracles to IPFS and register them on-chain using the newton-cli command line tool."
keywords:
  - newton cli
  - deploy policy to ipfs
  - newton protocol deployment
  - wasm oracle deployment
  - blockchain policy deployment
---
