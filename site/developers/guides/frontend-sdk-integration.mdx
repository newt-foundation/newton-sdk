...
description: "Build a Next.js frontend that submits Newton Protocol evaluation requests and executes attested transactions. Full walkthrough with viem, TypeScript, and Sepolia testnet."
keywords:
  - newton sdk nextjs
  - viem wallet client
  - policy evaluation frontend
  - typescript blockchain dapp
  - attested transaction execution
---
