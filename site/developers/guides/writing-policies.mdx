...
Newton policies use **Rego v1** and are evaluated by the Newton Regorus engine. The engine supports an OPA v1.2.0-compatible subset of Rego, along with Newton-specific extensions.
