...
description: "Write Rego policies for blockchain transaction authorization with Newton Protocol. Examples for spend limits, allowlists, and sanctions screening."
keywords:
