...
<CardGroup cols={2}>
  <Card title="Example Repo" icon="github" href="https://github.com/newt-foundation/verifiable-credential-example">
    Clone the repo and follow the README to run the full VC flow locally
  </Card>

  <Card title="Live Demo" icon="browser" href="https://verifiable-credential-example.vercel.app/">
    Try the live demo
  </Card>
</CardGroup>
...
| Requirement | Details |
| --- | --- |
| **Newton SDK** | `@newton-xyz/sdk` installed in your JavaScript/TypeScript app |
...
Before invoking the identity popup, your application must display a notice to the user explaining that their identity data will be encrypted and processed by the Newton Protocol. At minimum this notice should state: "Your identity data is encrypted before leaving your device. It is processed by the Newton Protocol to verify your eligibility."  You are responsible for ensuring this disclosure is presented, not buried in your terms of service.
...
<CardGroup cols={2}>
  <Card title="SDK & Contract Reference" icon="code" href="/developers/verified-credential/reference">
    Full SDK method signatures and contract functions
  </Card>

  <Card title="Identity Policy Reference" icon="brackets-curly" href="/developers/verified-credential/identity-policy-reference">
    All Rego built-in functions for identity checks
  </Card>
</CardGroup>

<Card title="Have questions?" icon="comment-question" href="https://calendly.com/d/cxcy-vqp-9cm/meet-with-the-newton-team">
