...
|-----------|------|-------------|
| `userData` | `unknown` | KYC data object from your identity vendor |
...
Connects a user's identity with Newton. Used to initiate the Newton identity popup for an existing user.
