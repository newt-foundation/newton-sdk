...
description: "Frequently asked questions and solutions to common issues with Newton Protocol — API keys, policy evaluation, chain support, error codes, and debugging."
keywords:
  - newton protocol faq
  - newton troubleshooting
  - eigenlayer avs help
  - policy evaluation errors
  - blockchain compliance faq
---
...
Newton currently supports **Ethereum Mainnet** (`1`), **Ethereum Sepolia** (`11155111`), and **Base Sepolia** (`84532`). See [Supported Networks](/developers/concepts/multichain#supported-networks).
</Accordion>
