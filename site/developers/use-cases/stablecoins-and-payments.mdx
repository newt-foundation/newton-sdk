...
Traditional approaches force a choice: either centralized compliance (a server that can block transfers) or no compliance at all. Newton eliminates this tradeoff.
