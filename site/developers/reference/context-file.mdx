...
For how Newton policies work — the WASM oracle plus Rego evaluated by Regorus — start with the [Newton Mental Model](/developers/overview/mental-model). The downloadable Gists below are fuller packs for coding assistants.
