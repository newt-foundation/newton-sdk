...
- **Policy packs** provide ready-made data inputs and Rego guardrails for vault risk, address screening, price divergence, and depositor reputation. See [Policy Packs](/developers/vaults/policy-packs).
...
<Card title="Policy Packs" icon="shield-check" href="/developers/vaults/policy-packs">
...
<Card title="Protocol Concepts" icon="network" href="/developers/vaults/protocol/concepts">
  Understand intents, attestations, tasks, and operator evaluation.
</Card>

<Card title="Shield Contract" icon="lock" href="/developers/vaults/shield/architecture">
  Review how Shield clones are deployed, validated, and operated.
</Card>
