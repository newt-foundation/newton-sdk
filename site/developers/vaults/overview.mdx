...
- **Newton VaultKit** is a coming-soon SDK for curator-facing vault integrations, starting with Morpho. See [Vault SDK](/developers/vaults/sdk/overview).
...
<Card title="Vault SDK" icon="package" href="/developers/vaults/sdk/overview">
  Learn about the coming-soon Newton VaultKit for curator workflows.
</Card>
