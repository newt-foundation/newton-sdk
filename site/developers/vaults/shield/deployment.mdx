...
For local or staging work, use a local chain and non-production gateway environment. Local artifacts should not be treated as audit records for production deployment.
