...
Use `sendCall(...)` for vendor manager actions when your app already has the target ABI and arguments.
...
const result = await shield.sendCall({
  ...
  data: encodeFunctionData({
    ...
    args: [[{ marketId: '0xMarketId', assets: 1_000_000n }]],
  }),
...
Newton operators evaluate the configured policy before the Shield forwards the encoded calldata.
