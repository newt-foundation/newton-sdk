...
<Frame>
  <img
    ...
    alt="Problem: smart contracts lack offchain context"
  />
</Frame>
...
<Frame>
  <img
    ...
    alt="Solution: Newton bridges offchain data to smart contracts"
  />
</Frame>
...
<Card title="Try the demo" icon="play" href="https://demo.newton.xyz/">
  See a live example of a Newton-powered sanctions-checked transfer app
</Card>

<Card title="Talk to an expert" icon="headphones" href="https://calendly.com/d/cxcy-vqp-9cm/meet-with-the-newton-team">
...
<Card title="Quickstart" icon="rocket" href="/developers/overview/quickstart">
...
<Card title="Core Concepts" icon="lightbulb" href="/developers/overview/core-concepts">
