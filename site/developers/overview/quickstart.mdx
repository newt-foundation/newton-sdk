...
- **A Newton API key** — create one via the [Dashboard API](/developers/overview/dashboard-api-keys), or email [product@magicnewton.com](mailto:product@magicnewton.com)
