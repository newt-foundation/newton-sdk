...
Newton supports **Rego v1** through the Newton Regorus engine. The engine implements an OPA v1.2.0-compatible subset of Rego and adds Newton-specific extensions documented in this guide.
