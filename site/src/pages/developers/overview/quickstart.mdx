...
async function main() {
  ...
  const result = await walletClient.simulateTask({
    intent: {
      ...
      data: '0x28dca9f700000000000000000000000000000000000000000000000000000000e42e3458' as `0x${string}`,  // ABI-encoded function call (buy/transfer)
      chainId: 11155111,                                      // Sepolia
      functionSignature: '0x62757900' as `0x${string}`,       // buy(address,uint256,uint32) encoded
    },
    policyTaskData: {
      // Pre-deployed OFAC sanctions policy — you can use this for testing
      policyId: '0x27b7c88f00000000000000000000000000000000000000000000000000000000eecd1626' as `0x${string}`,
...
:::details[Alternative: AI-assisted build]
