...
# Overview [Use Newton Protocol to add verifiable risk, compliance, and privacy guardrails to DeFi vault operations.]
...
- **Policy packs** provide ready-made data inputs and Rego guardrails for vault risk, address screening, price divergence, and depeg risk. See [Policy Packs](/developers/vaults/policy-packs).
- **Newton VaultKit** provides the SDK and Shield contracts for curator-facing vault integrations, starting with Morpho and generic call support for other protocols. See [Vault SDK](/developers/vaults/sdk/overview).

<Card title="Policy Packs" icon="shield-check" to="/developers/vaults/policy-packs">
  Review the policy packs Newton makes available for vault risk, compliance, and oracle checks.
</Card>

<Card title="Vault SDK" icon="package" to="/developers/vaults/sdk/overview">
  Integrate Newton VaultKit into curator workflows.
</Card>

<Card title="Protocol Concepts" icon="network" to="/developers/vaults/protocol/concepts">
  Understand intents, attestations, tasks, and operator evaluation.
</Card>
