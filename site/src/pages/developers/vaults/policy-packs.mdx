...
| [Arkham Entity-Aware Spending Gate](/developers/vaults/policies/arkham-entity) | Tiering a spending limit by who the destination actually is |
| [Arkham Adaptive Counterparty Gate](/developers/vaults/policies/arkham-counterparty) | Judging a payment against the sending wallet's own history and outflow baseline |
| [Arkham Explainable Risk Exposure](/developers/vaults/policies/arkham-risk) | Denying exposure you can trace to a specific transaction route |
| [Pharos Risk-Adjusted Treasury Gate](/developers/vaults/policies/pharos-treasury) | Admitting a stablecoin only when peg, stress, redemption, and exit capacity are all healthy |
| [Pharos Stablecoin Safe Mode](/developers/vaults/policies/pharos-safe-mode) | Blocking exposure-increasing actions under stress while leaving withdrawals open |
| [Pharos Redemption-Backed Asset Gate](/developers/vaults/policies/pharos-redemption) | Admitting a stablecoin only when it can actually be redeemed at par |
| Balancer | Adding keyless Balancer pool or market data |
| Blockaid | Screening transaction and address risk |
| Guardrail | Adding a Guardrail risk signal |
| Persona | Adding identity and verification checks |
| Sumsub | Adding KYC and verification checks |
