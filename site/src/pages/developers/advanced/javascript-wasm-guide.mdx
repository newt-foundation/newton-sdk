...
# Writing Data Oracles in JavaScript

This guide walks you through building a JavaScript newton-provider WebAssembly component using ComponentizeJS (@bytecodealliance/componentize-js). 
