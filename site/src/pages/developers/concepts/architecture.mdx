---
title: "Architecture"
description: "Newton Protocol system architecture — policy definition, AVS operator evaluation, and on-chain verification layers. How EigenLayer operators evaluate and attest to policy decisions."
keywords:
  - newton protocol architecture
  - avs policy engine
  - eigenlayer avs design
  - onchain verification layer
  - bls attestation architecture
...
# Architecture [Newton Protocol system architecture — policy definition, AVS operator evaluation, and on-chain verification layers. How EigenLayer operators evaluate and attest to policy decisions.]
