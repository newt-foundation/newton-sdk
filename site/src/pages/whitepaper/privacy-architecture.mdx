...
# Privacy Architecture [Newton Protocol's layered privacy architecture: HPKE encryption, threshold decryption, MPC evaluation, and the Newton Privacy Envelope.]
