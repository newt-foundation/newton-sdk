...
Summary: this walkthrough starts the local gateway/operator stack with Docker Compose, then submits the zkTLS request generated by the quickstart to the local gateway.
